...
def build_parser() -> argparse.ArgumentParser:
    ...
    init_parser.add_argument("--write-agent-guide", action="store_true", dest="write_agent_guide")
    init_parser.add_argument("--force-agent-guide", action="store_true", dest="force_agent_guide")
    agent = subparsers.add_parser("agent").add_subparsers(dest="agent_command", required=True)
    agent_guide = agent.add_parser("guide")
    agent_guide.add_argument("--force", action="store_true")
    agent.add_parser("instructions")
    ...
    plan_add.add_argument("--force-create", action="store_true", dest="force_create")
    ...
    decision_add.add_argument("--force-create", action="store_true", dest="force_create")
    ...
    task_add.add_argument("--force-create", action="store_true", dest="force_create")
    ...
    task_note = task.add_parser("note")
    task_note.add_argument("--id", required=True)
    task_note.add_argument("--content", required=True)
    task_notes = task.add_parser("notes")
    task_notes.add_argument("--id", required=True)
    task_notes.add_argument("--limit", type=int, default=20)
    ...
    commit_list.add_argument("--since", default="")
    commit_list.add_argument("--limit", type=int, default=None)
    commit_list.add_argument("--compact", action="store_true")
    ...
    bug = subparsers.add_parser("bug").add_subparsers(dest="bug_command", required=True)
    bug_list = bug.add_parser("list")
    bug_list.add_argument("--status", default="")
    bug_list.add_argument("--severity", default="")
    bug_list.add_argument("--commit-id", default="", dest="commit_id")
    bug_list.add_argument("--limit", type=int, default=None)
    bug_show = bug.add_parser("show")
    bug_show.add_argument("--id", required=True)
    bug_add = bug.add_parser("add")
    bug_add.add_argument("--title", required=True)
    bug_add.add_argument("--description", default="")
    bug_add.add_argument("--severity", default="minor")
    bug_add.add_argument("--status", default="open")
    bug_add.add_argument("--commit-id", default="", dest="commit_id")
    bug_update = bug.add_parser("update")
    bug_update.add_argument("--id", required=True)
    bug_update.add_argument("--title", default=None)
    bug_update.add_argument("--description", default=None)
    bug_update.add_argument("--severity", default=None)
    bug_update.add_argument("--status", default=None)
    bug_update.add_argument("--commit-id", default=None, dest="commit_id")
    bug_update.add_argument("--clear-commit-id", action="store_true", dest="clear_commit_id")
    ...
    daily_close.add_argument("--completed", action="append", nargs="+", default=[])
    daily_close.add_argument("--problems", action="append", nargs="+", default=[])
    daily_close.add_argument("--risks", action="append", nargs="+", default=[])
    daily_close.add_argument("--next", action="append", nargs="+", default=[])
    daily_close.add_argument("--from-commits", action="store_true", dest="from_commits")
    daily_close.add_argument("--from-tasks", action="store_true", dest="from_tasks")
    daily_replace = daily.add_parser("replace")
    daily_replace.add_argument("--date", default=None)
    daily_replace.add_argument("--completed", action="append", nargs="+", default=[])
    daily_replace.add_argument("--problems", action="append", nargs="+", default=[])
    daily_replace.add_argument("--risks", action="append", nargs="+", default=[])
    daily_replace.add_argument("--next", action="append", nargs="+", default=[])
    daily_replace.add_argument("--from-commits", action="store_true", dest="from_commits")
    daily_replace.add_argument("--from-tasks", action="store_true", dest="from_tasks")
    session = subparsers.add_parser("session").add_subparsers(dest="session_command", required=True)
    session_close = session.add_parser("close")
    session_close.add_argument("--task-id", default="", dest="task_id")
    session_close.add_argument("--note", default="")
    session_close.add_argument("--completed", action="append", nargs="+", default=[])
    session_close.add_argument("--problems", action="append", nargs="+", default=[])
    session_close.add_argument("--risks", action="append", nargs="+", default=[])
    session_close.add_argument("--next", action="append", nargs="+", default=[])
    session_close.add_argument("--from-commits", action="store_true", default=True, dest="from_commits")
    session_close.add_argument("--no-from-commits", action="store_false", dest="from_commits")
    session_close.add_argument("--from-tasks", action="store_true", default=True, dest="from_tasks")
    session_close.add_argument("--no-from-tasks", action="store_false", dest="from_tasks")
